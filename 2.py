...
# Yahoo!'s limit on the number of days they will forecast and will only show for next 5 days
DAYS_LIMIT = 5
WEATHER_URL = '  https://www.theweathernetwork.com/ca/'
METRIC_PARAMETER = '&u=c'
WEATHER_NS = 'https://www.theweathernetwork.com/ca/weather/15/nova-scotia/halifax '
